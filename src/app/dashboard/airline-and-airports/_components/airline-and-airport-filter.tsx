...
interface AirlineAndAirportFilterProps {
  onFilterChange?: () => void;
}
...
export function AirlineAndAirportFilter({ onFilterChange }: AirlineAndAirportFilterProps) {
  ...
  const pushWithParams = (updates: UpdateParams) => {
    ...
    router.push(`/dashboard/airline-and-airports${newQuery}`, { scroll: false });
    onFilterChange?.();
  };
